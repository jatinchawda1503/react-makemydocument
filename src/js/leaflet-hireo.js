...
$(document).ready(function(){
	...
	function singleListingMap() {
		...
		var zoomOptions = {
			zoomInText: '<i  aria-hidden="true"></i>',
			zoomOutText: '<i  aria-hidden="true"></i>',
		};
		...
		// 	maxZoom: 18,
		// 	id: 'mapbox.streets',
		// 	accessToken: 'sk.eyJ1IjoiYmxpc3NmdWxwb3J0YWxzIiwiYSI6ImNrZ2IxY2JxMDA5OHIycnFha3QzMTUwZzIifQ.Ib9oTtfcF4z32GIO5OXPDg'
		// }).addTo(map_single);
